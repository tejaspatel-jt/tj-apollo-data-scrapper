...
MASTER_SHEET_NAME = "Sheet1"   # <- change if your tab has a different name
...
SOURCE_SHEET_NAME = "Sheet1"   # <- change if needed (usually Sheet1 or the only tab)
...
def main():
    ...
    master_headers, master_rows = load_sheet(master_path, MASTER_SHEET_NAME, "Master")
    ...
    src_headers, src_rows = load_sheet(source_path, SOURCE_SHEET_NAME, "Source")
